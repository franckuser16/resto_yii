...
class PartitionsController extends Controller
{
	...
	{
		$model=new Partitions;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Partitions']))
		{
	...
	{
		$dataProvider=new CActiveDataProvider('Partitions');
	...
	{
		$model=new Partitions('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Partitions']))
			$model->attributes=$_GET['Partitions'];
	...
	{
		$model=Partitions::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='partitions-form')
		{
